...
<div class="container">
  <audio id="audio" preload="none" tabindex="0">
    			...
    			Your browser does not support HTML5 audio.  
    			<source src="https://docs.google.com/uc?export=open&id=1AFNIPzwBx911lDloR-Nk-hvoFZOmysGP" data-track-number="16" />
    			Your browser does not support HTML5 audio.  
    			<source src="https://docs.google.com/uc?export=open&id=1wjPzoHbgW2DlA2Jbcgy0CIlPTc-qjPAh" data-track-number="17" />
    			Your browser does not support HTML5 audio.  
    			<source src="https://docs.google.com/uc?export=open&id=1RbFyICI2FR6ijWiL6NpTdC2zkV8a37Xt" data-track-number="18" />
    			Your browser does not support HTML5 audio.  
    			<source src="https://docs.google.com/uc?export=open&id=1L_DRStPn-412tb3nNu-IAz23b1bQ4PLQ" data-track-number="19" />
    			Your browser does not support HTML5 audio.  
    			<source src="https://docs.google.com/uc?export=open&id=1kz03xArUwGFQw_cCAZT-JHlzVWPB_xOk" data-track-number="20" />
    			Your browser does not support HTML5 audio.  
    		</audio>
  ...
  <div class="play-list">
    ...
    <div class="play-list-row" data-track-row="16">
      ...
      <div class="track-title">
        <a class="playlist-track" href="#" data-play-track="16">Stringenzen 16 (2023)</a>
      </div>
    </div>  
    ...
    <div class="play-list-row" data-track-row="17">
      ...
      <div class="track-title">
        <a class="playlist-track" href="#" data-play-track="17">Stringenzen 17 (2023)</a>
      </div>
    </div>  
    ...
    <div class="play-list-row" data-track-row="18">
      ...
      <div class="track-title">
        <a class="playlist-track" href="#" data-play-track="18">Stringenzen 18 (2023)</a>
      </div>  
    </div>  
    ...
    <div class="play-list-row" data-track-row="19">
      ...
      <div class="track-title">
        <a class="playlist-track" href="#" data-play-track="19">Stringenzen 19 (2023)</a>
      </div>  
     </div>  
    ...
    <div class="play-list-row" data-track-row="20">
      ...
      <div class="track-title">
        <a class="playlist-track" href="#" data-play-track="20">Stringenzen 20 (2023)</a>
      </div>  
    </div>  
